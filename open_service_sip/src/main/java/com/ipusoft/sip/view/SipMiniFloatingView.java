 ...
 */
public class SipMiniFloatingView extends View {

    private final String TAG = SipMiniFloatingView.class.getSimpleName();
    /**
     * 默认宽高与当前View实际宽高
     */
    ...
    public SipMiniFloatingView(Context context) {
        super(context);
        init();
    }
    ...
    private void init() {
        ...
        // mLayoutParams.y = SizeUtils.dp2px(120);
        ...
        if (mWindowManager != null) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    Log.d(TAG, "onTouchEvent: ------------>" + (int) event.getRawX() + "---->" + (int) event.getRawY());
