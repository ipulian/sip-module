...
import com.ipusoft.siplibrary.config.DSConfig;
...
public class SIPModuleMMKV {

    private static final MMKV mv = MMKV.mmkvWithID(DSConfig.SIP_MODULE_DS);

    private SIPModuleMMKV() {
    }
