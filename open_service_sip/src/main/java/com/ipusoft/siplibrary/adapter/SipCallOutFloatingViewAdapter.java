package com.ipusoft.siplibrary.adapter;
...
import com.ipusoft.context.utils.DateTimeUtils;
...
public class SipCallOutFloatingViewAdapter {
    private SipCallOutInfoBean bean;
    private SipCallOutFloatingView mView;
    ...
    public void updateView(SipCallOutFloatingView mWindowView) {
    ...
    protected void initLabel(WrapLinearLayout wllLabel, String label) {
        if (StringUtils.isNotEmpty(label)) {
            ...
            for (String str : label.split(",")) {
                ...
                llLabelRoot.setBackground(ResourceUtils.getDrawable(R.drawable.bg_label_cell2));
